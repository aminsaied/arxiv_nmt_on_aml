...
def deploy_step(model_dir, eval_dir, test_dir, compute_target):
    '''
    ...
    :param eval_dir: The reference to the directory containing the evaluation accuracy
    :type eval_dir: DataReference
    ...
    step = PythonScriptStep(
        ...
        inputs=[model_dir, eval_dir, test_dir],
        outputs=outputs,
